...
import DemoForm from './ui/DemoForm.jsx'
  ...
  return (
    <div id="top" className="relative">
      ...
      <main className="relative z-10">
        <Hero reducedMotion={reducedMotion} onOpenDemo={() => setDemoOpen(true)} />
        {NODES.map((node) => (
          <NodeSection key={node.id} node={node} reducedMotion={reducedMotion} />
        ))}
        <Recap reducedMotion={reducedMotion} />
        <Cta reducedMotion={reducedMotion} onOpenDemo={() => setDemoOpen(true)} />
      </main>
